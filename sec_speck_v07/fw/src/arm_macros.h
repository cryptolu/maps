...
#define SEC_ADD(x_mval, x_mask, y_mval, y_mask, a, b, p, g, h, u, t) \
        /* p(mval, mask) = (p, x_mask) */                                \
        /*SEC_XOR(p, x_mval, x_mask, y_mval, y_mask)*/                   \
        SEC_XOR(p, y_mval, y_mask, x_mval, x_mask)                       \
                                                                         \
        /* g(mval, mask) = (g, a) */                                     \
        SEC_AND(g, a, x_mval, x_mask, y_mval, y_mask, t)                 \
                                                                         \
